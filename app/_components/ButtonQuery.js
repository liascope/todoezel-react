...
function handleQuery(e){
  ...
  setQuery('')
   ...
   return <> <input type="text" className="w-full my-2 sm:my-9 py-1 sm:py-2 text-center border border-green-400 hover:border-amber-400 bg-stone-900/70 rounded-md sm:ml-30"
            placeholder={placeholder}
            value={query}
            onChange={(e) => setQuery(e.target.value)}
          />
          <Button onClick={handleQuery}><svg className="w-[28px] h-[28px]" viewBox="0 0 52 52" xmlns="http://www.w3.org/2000/svg">
