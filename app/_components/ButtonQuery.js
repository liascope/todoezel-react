...
function handleQuery(e){
  ...
  setQuery('')
   ...
   return <> <input type="text" className="w-full m-1 sm:my-9 p-2 text-sm sm:text-lg text-center border border-green-400 hover:border-amber-400 bg-stone-900/70 rounded-md sm:ml-5"
